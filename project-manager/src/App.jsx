    ...
    <Router>
      <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className={`flex-1 transition-all duration-200 ${isSidebarOpen ? 'ml-80' : 'ml-0'}`}>
          <div className="p-8">
            <Routes>
              <Route path="/" element={<Dashboard projects={projects} onAddProject={handleAddProject} />} />
              <Route path="/projects" element={<Projects projects={projects} onAddProject={handleAddProject} />} />
